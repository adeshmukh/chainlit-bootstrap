...
def download_spacy_model(model_name="en_core_web_sm", output_dir=".local/cache/spacy-models"):
    ...
    try:
        ...
        with urllib.request.urlopen('https://api.github.com/repos/explosion/spacy-models/releases?per_page=100') as response:
